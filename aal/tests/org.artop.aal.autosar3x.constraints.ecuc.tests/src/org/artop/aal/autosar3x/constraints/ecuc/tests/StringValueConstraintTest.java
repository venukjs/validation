...
public class StringValueConstraintTest extends AbstractAutosar3xValidationTestCase {
	...
	public void testInvalidStringValue_wrongParamDefType() throws Exception {
		...
		ValidationTestUtil.validateModel(invalidModel, validator, IStatus.ERROR,
				NLS.bind(EcucConstraintMessages.generic_definitionNotOfType, "string param def"));
	}
