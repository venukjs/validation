...
public class IntegerParamDefConstraintTests extends AbstractAutosar3xValidationTestCase {

	public IntegerParamDefConstraintTests() {
		super();
	}

	@Override
	protected String getConstraintID() {
		return "org.artop.aal.autosar3x.constraints.ecuc.IntegerParamDefDefaultValueConstraint_3x";//$NON-NLS-1$
	}
