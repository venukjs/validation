...
public class FunctionNameDefConstraintTests extends AbstractAutosar3xValidationTestCase {

	public FunctionNameDefConstraintTests() {
		super();
	}

	@Override
	protected String getConstraintID() {
		return "org.artop.aal.autosar3x.constraints.ecuc.FunctionNamelDefDefaultValueConstraint_3x";//$NON-NLS-1$
	}
