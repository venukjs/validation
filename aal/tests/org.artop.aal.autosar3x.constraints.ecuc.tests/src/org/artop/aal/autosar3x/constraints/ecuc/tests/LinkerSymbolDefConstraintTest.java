...
public class LinkerSymbolDefConstraintTest extends AbstractAutosar3xValidationTestCase {

	public LinkerSymbolDefConstraintTest() {
		super();
	}

	@Override
	protected String getConstraintID() {
		return "org.artop.aal.autosar3x.constraints.ecuc.LinkerSymbolDefDefaultValueConstraint_3x";//$NON-NLS-1$
	}
