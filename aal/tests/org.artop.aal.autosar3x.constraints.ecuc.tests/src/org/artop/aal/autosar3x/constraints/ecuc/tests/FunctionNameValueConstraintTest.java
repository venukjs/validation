...
public class FunctionNameValueConstraintTest extends AbstractAutosar3xValidationTestCase {

	public FunctionNameValueConstraintTest() {
		super();
	}
	...
	public void testInvalidFunctionNameValue_wrongParamDefType() throws Exception {
		...
		ValidationTestUtil.validateModel(invalidModel, validator, IStatus.ERROR,
				NLS.bind(EcucConstraintMessages.generic_definitionNotOfType, "function name param def"));
	}
