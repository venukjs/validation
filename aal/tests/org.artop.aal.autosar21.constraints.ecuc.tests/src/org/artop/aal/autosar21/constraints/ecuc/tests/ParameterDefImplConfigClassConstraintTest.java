 ...
 */
public class ParameterDefImplConfigClassConstraintTest extends AbstractAutosar21ValidationTestCase {

	@Override
	protected String getConstraintID() {
		return "org.artop.aal.autosar21.constraints.ecuc.ConfigParameterImplConfigClassConstraint_21"; //$NON-NLS-1$
	}
