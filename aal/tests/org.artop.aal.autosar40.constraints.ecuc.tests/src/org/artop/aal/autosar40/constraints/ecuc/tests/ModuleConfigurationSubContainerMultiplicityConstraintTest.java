...
public class ModuleConfigurationSubContainerMultiplicityConstraintTest extends AbstractAutosar40ValidationTestCase {

	public ModuleConfigurationSubContainerMultiplicityConstraintTest() {
		super();
	}
