...
public class ContainerParameterMultiplicityConstraintTests extends AbstractAutosar40ValidationTestCase {

	public ContainerParameterMultiplicityConstraintTests() {
		super();
	}
