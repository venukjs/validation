...
public class EcucIntegerParamDefConstraintTests extends AbstractAutosar40ValidationTestCase {

	public EcucIntegerParamDefConstraintTests() {
		super();
	}

	@Override
	protected String getConstraintID() {
		return "org.artop.aal.autosar40.constraints.ecuc.EcucIntegerParamDefDefaultValueConstraint_40";//$NON-NLS-1$
	}
