...
public class EcucFloatParamDefConstraintTests extends AbstractAutosar40ValidationTestCase {

	public EcucFloatParamDefConstraintTests() {
		super();
	}

	@Override
	protected String getConstraintID() {
		return "org.artop.aal.autosar40.constraints.ecuc.EcucFloatParamDefDefaultValueConstraint_40";//$NON-NLS-1$
	}
