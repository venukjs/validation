...
public class StringParamDefConstraintTests extends AbstractAutosar40ValidationTestCase {
	...
	protected String getConstraintID() {
		return "org.artop.aal.autosar40.constraints.ecuc.EcucStringParamDefDefaultValueConstraint_40";//$NON-NLS-1$
	}
