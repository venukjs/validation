...
public class ContainerReferenceMultiplicityConstraintTests extends AbstractAutosar40ValidationTestCase {

	public ContainerReferenceMultiplicityConstraintTests() {
		super();
	}
