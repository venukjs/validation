...
public class ConfigParameterLinkTimeConstraint extends AbstractImplConfigClassAndVariantConstraint {
	@Override
	...
	protected boolean isExpectedConfigVariant(EObject target) {
		...
		return configVariant.equals("VARIANT-LINK-TIME"); //$NON-NLS-1$
	}
