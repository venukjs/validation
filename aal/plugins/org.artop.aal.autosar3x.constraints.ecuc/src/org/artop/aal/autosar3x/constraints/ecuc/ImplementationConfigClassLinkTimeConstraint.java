...
public class ImplementationConfigClassLinkTimeConstraint extends AbstractImplConfigClassAndVariantConstraint {
	...
	protected boolean isExpectedConfigVariant(EObject target) {
		...
		return cv == ConfigurationVariant.VARIANT_LINK_TIME;
	}

	@Override
	protected Enumerator[] getAllowedConfigClassEnum(EObject target) {
		return new Enumerator[] { ConfigurationClass.PRE_COMPILE, ConfigurationClass.PUBLISHED_INFORMATION, ConfigurationClass.LINK };
	}
