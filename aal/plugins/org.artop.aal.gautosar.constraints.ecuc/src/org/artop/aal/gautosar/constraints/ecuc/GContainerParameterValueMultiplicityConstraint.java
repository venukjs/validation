 ...
 */
public class GContainerParameterValueMultiplicityConstraint extends AbstractSplitModelConstraintWithPreconditionAndIndex {
	@Override
	...
	public IStatus doValidate(IValidationContext ctx) {
		...
		if (gParamConfContainerDef != null) {
			// if the container has the multiplicity 0 then the parameters shall not be validated anymore
