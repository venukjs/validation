...
/**
 * 
 * Superclass for the constraints implementations on the multiplicity of
 * subcontainers of a module configuration.
 * 
 */
public abstract class AbstractGModuleConfigurationSubContainerMultiplicityConstraint
		extends AbstractModelConstraintWithPrecondition
{
	...
	public IStatus doValidate(IValidationContext ctx)
	{
		...
		List<GContainer> allSubContainers = EcucUtil
				.getAllContainersOf(gModuleConfiguration);
		...
		for (GContainerDef currentSubGContainerDef : subGContainerDefs)
		{
			int numberOfSubContainers = EcucUtil
					.getNumberOfUniqueContainersByDefinition(allSubContainers,
