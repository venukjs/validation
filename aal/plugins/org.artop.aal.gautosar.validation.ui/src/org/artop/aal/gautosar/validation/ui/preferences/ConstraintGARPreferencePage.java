 ...
 * </copyright>
 */
package org.artop.aal.gautosar.validation.ui.preferences;
...
public class ConstraintGARPreferencePage extends ConstraintPreferencePage {

	private static final String GAUTOSAR = "gautosar."; //$NON-NLS-1$
	...
	protected Control createContents(Composite parent) {
		...
		final String filter = ConstraintUtil.getModelFilter(GAUTOSAR);
