...
public class EcucFunctionNameDefDefaultValueConstraint extends AbstractGFunctionNameDefDefaultValueConstraint {

	@Override
	protected String getDefaultValue(GAbstractStringParamDef functionParamDef) {
		return EcucUtil40.getDefaultValue(functionParamDef);
