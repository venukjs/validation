...
public class EcucModuleConfigurationValuesBasicConstraint extends AbstractGModuleConfigurationBasicConstraint {
	...
	protected IStatus validateImplementationConfigVariant(IValidationContext ctx, GModuleConfiguration gModuleConfiguration) {
		...
		if (false == moduleConfiguration.isSetImplementationConfigVariant()) {
			...
			EcucConfigurationVariantEnum configVariant = moduleConfiguration.getImplementationConfigVariant();
			EcucModuleDef moduleDef = moduleConfiguration.getDefinition();
			List<EcucConfigurationVariantEnum> supportedConfigVariants = moduleDef.getSupportedConfigVariants();
