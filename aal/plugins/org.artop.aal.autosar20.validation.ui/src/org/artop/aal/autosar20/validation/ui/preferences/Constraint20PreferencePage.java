 ...
 * </copyright>
 */
package org.artop.aal.autosar20.validation.ui.preferences;
...
public class Constraint20PreferencePage extends ConstraintPreferencePage {
	@Override
	protected Control createContents(Composite parent) {
		...
		final String filter = ConstraintUtil.getModelFilter(Autosar20Factory.eINSTANCE.createARPackage());
