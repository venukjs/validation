...
public class IntegerValueConstraintTests extends AbstractAutosar20ValidationTestCase
{
	...
	protected String getConstraintID() {
		return "org.artop.aal.autosar20.constraints.ecuc.IntegerValueBasicConstraint_20";//$NON-NLS-1$
	}
