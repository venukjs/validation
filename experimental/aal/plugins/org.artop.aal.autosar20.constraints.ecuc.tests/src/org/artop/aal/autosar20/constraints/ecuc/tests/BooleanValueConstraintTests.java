...
public class BooleanValueConstraintTests extends AbstractAutosar20ValidationTestCase
{
	...
	{
		return "org.artop.aal.autosar20.constraints.ecuc.BooleanValueBasicConstraint_20";//$NON-NLS-1$
