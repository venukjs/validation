...
public class ContainerSubContainerMultiplicityConstraintTest extends AbstractAutosar3xValidationTestCase {
	public ContainerSubContainerMultiplicityConstraintTest() {
		super();
	}
	...
	public void testInvalidContainer_choiceContainerMoreThanOneChoiceSelected() throws Exception {
		...
		ValidationTestUtil.validateModel(invalidModel, validator, IStatus.ERROR,
				NLS.bind(EcucConstraintMessages.multiplicity_subContainersExpected, "choice container"));
	}
	...
	public void testInvalidContainer_mandatorySubContainerMissing() throws Exception {
		...
		ValidationTestUtil.validateModel(
				...
				validator,
				IStatus.ERROR,
				NLS.bind(EcucConstraintMessages.multiplicity_minElementsExpected, new String[] { "1", "subcontainers",
